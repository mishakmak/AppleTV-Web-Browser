...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([cookieData length] > 0) {
        NSArray *cookies = [NSKeyedUnarchiver unarchivedObjectOfClass:[NSArray class] fromData:cookieData error:nil];
...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    NSData *cookieData = [NSKeyedArchiver archivedDataWithRootObject:[[NSHTTPCookieStorage sharedHTTPCookieStorage] cookies] requiringSecureCoding:false error:nil];
